...
const CONFIG_FILE_OLD = path.join(os.homedir(), ".oca", "oca-proxy-config.json")
export const CONFIG_FILE = path.join(os.homedir(), ".config", "oca", "oca-proxy.config.json")
...
export const OCA_CONFIG = {
	...
	idcs_url: userConfig.idcs_url || "https://idcs-9dc693e80d9b469480d7afe00e743931.identity.oraclecloud.com",
	scopes: "openid offline_access",
	base_url: userConfig.base_url || "https://code-internal.aiservice.us-chicago-1.oci.oraclecloud.com/20250206/app/litellm",
}
...
export const PROXY_PORT = parseInt(process.env.PORT || String(userConfig.port || 8669), 10)
